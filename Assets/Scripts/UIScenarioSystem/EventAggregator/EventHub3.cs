...
{
    public abstract class EventHub<TEvent, TValue1, TValue2, TValue3> : EventHubBase
    ...
    public abstract class EventHubV<TEvent, TValue1, TValue2, TValue3> : EventHub<TEvent, TValue1, TValue2, TValue3>
